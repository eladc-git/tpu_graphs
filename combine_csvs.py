...
_OUTPUT_CSV = flags.DEFINE_string(
    'output', '/data/projects/swat/users/eladco/models/TpuGraphs/submissions/tpugraphs_submission_'+VERSION+'.csv', 'Path to output CSV')
...
_DEFAULT_INPUTS = [
    (_TILE_CSV, '/data/projects/swat/users/eladco/models/TpuGraphs/'+VERSION+'/results_*_tile.csv'),
    (_LAYOUT_NLP_RANDOM_CSV, '/data/projects/swat/users/eladco/models/TpuGraphs/'+VERSION+'/results_*_nlp_random.csv'),
    (_LAYOUT_NLP_DEFAULT_CSV,
     '/data/projects/swat/users/eladco/models/TpuGraphs/'+VERSION+'/results_*_nlp_default.csv'),
    (_LAYOUT_XLA_RANDOM_CSV, '/data/projects/swat/users/eladco/models/TpuGraphs/'+VERSION+'/results_*_xla_random.csv'),
    (_LAYOUT_XLA_DEFAULT_CSV,
     '/data/projects/swat/users/eladco/models/TpuGraphs/'+VERSION+'/results_*_xla_default.csv'),
]
